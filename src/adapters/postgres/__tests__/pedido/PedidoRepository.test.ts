...
describe('PedidoRepository', () => {
    ...
    it('should create a Pedido', async () => {
      ...
      expect(PedidoModel.create).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it('should find a Pedido by id', async () => {
        ...
        expect(PedidoModel.findByPk).toHaveBeenCalledWith('1', { include: [{ as: 'itens', model: expect.any(Function) }] });
      });
});